...
namespace gpconnect_appointment_checker.IntegrationTest
{
    ...
    public class DataServicePostApplicationTests
    {
        ...
        public async Task PostSynchronisedOrganisationData(string functionName, string odsCode, string organisationTypeCode, string organisationName, string address1, string address2, string locality, string city, string county, string postCode)
        {
            ...
            var result = await _dataService.ExecuteFunction<object>(functionName, parameters);
        ...
        public async Task PostLogonUserData(string functionName, string emailAddress, string displayName, int organisationId)
        {
            var parameters = new DynamicParameters();
    ...
    public class DataServiceGetApplicationTests
    {
        ...
        public async Task RetrieveInvalidOrganisationData(string functionName, string odsCode)
        {
            var parameters = new DynamicParameters();
        ...
        public async Task RetrieveValidOrganisationData(string functionName, string odsCode)
        {
            var parameters = new DynamicParameters();
            parameters.Add("_ods_code", odsCode, DbType.String, ParameterDirection.Input);
            var result = await _dataService.ExecuteFunction<object>(functionName, parameters);
    ...
    public class DataServiceGetConfigurationDataTests
    {
        ...
        public async Task RetrieveConfigurationData(string functionName)
        {
            var result = await _dataService.ExecuteFunction<object>(functionName);
            Assert.NotEmpty(result);
        }
    }
    ...
    public class DataServicePostLoggingTests
    {
        ...
        public async Task PostErrorLoggingData(string functionName, string application, string level, string message, string logger, string callSite, string exception)
        {
            var parameters = new DynamicParameters();
        ...
        public async Task PostSpineMessageLoggingData(string functionName, int messageTypeId, string requestPayload, string responsePayload, int roundTripTimeMs)
        {
            var parameters = new DynamicParameters();
            parameters.Add("_user_session_id", null);
        ...
        public async Task PostSpineMessageLoggingToWithGpConnectRequestData(
            string functionName,
            int messageTypeId,
        ...
        public async Task PostWebRequestData(
            string functionName,
            string description,
            string url,
            string referrer,

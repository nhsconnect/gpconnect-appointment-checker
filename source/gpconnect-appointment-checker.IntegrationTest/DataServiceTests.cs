...
namespace gpconnect_appointment_checker.IntegrationTest
{
    ...
    public class DataServicePostApplicationTests
    {
        ...
        public void PostSynchronisedOrganisationData(string schemaName, string functionName, string odsCode, string organisationTypeCode, string organisationName, string address1, string address2, string locality, string city, string county, string postCode)
        {
            ...
            var result = _dataService.ExecuteFunction<object>(schemaName, functionName, parameters);
        ...
        public void PostLogonUserData(string schemaName, string functionName, string emailAddress, string displayName, int organisationId)
        {
            var parameters = new DynamicParameters();
    ...
    public class DataServiceGetApplicationTests
    {
        ...
        public void RetrieveInvalidOrganisationData(string schemaName, string functionName, string odsCode)
        {
            var parameters = new DynamicParameters();
        ...
        public void RetrieveValidOrganisationData(string schemaName, string functionName, string odsCode)
        {
            var parameters = new DynamicParameters();
            parameters.Add("_ods_code", odsCode, DbType.String, ParameterDirection.Input);
            var result = _dataService.ExecuteFunction<object>(schemaName, functionName, parameters);
    ...
    public class DataServiceGetConfigurationDataTests
    {
        ...
        public void RetrieveConfigurationData(string schemaName, string functionName)
        {
            var result = _dataService.ExecuteFunction<object>(schemaName, functionName);
            Assert.NotEmpty(result);
        }
    }
    ...
    public class DataServicePostLoggingTests
    {
        ...
        public void PostErrorLoggingData(string schemaName, string functionName, string application, string level, string message, string logger, string callSite, string exception)
        {
            var parameters = new DynamicParameters();
        ...
        public void PostSpineMessageLoggingData(string schemaName, string functionName, int messageTypeId, string requestPayload, string responsePayload, int roundTripTimeMs)
        {
            var parameters = new DynamicParameters();
            parameters.Add("_user_session_id", null);
